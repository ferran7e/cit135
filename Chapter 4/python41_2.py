...
while playing == "y":
    ...
    # Prompts the user for custom words, and sets them accordingly depending on what the user selects.
    words = input("Would you like to change the words of multiples? (Y/N): ").lower()
    if words == "y":
        multiple_three_word = input("Enter a word for multiples of three: ")
        multiple_five_word = input("Enter a word for multiples of five: ")
    else:
